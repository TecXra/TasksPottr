...
<body>
	<nav class="navbar navbar-expand-lg navbar-light py-2 primary-bg">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mx-auto font-weight-bold register-list-btn">
					<li class="nav-item">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="media">
						<i class="primary-color fas fa-check-circle fa-lg mr-2 mt-2"></i>
	...
	<div class="container-fluid job-categories-container pb-5 pt-3">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> PHP </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Graphic Design </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Web Design </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> HTML </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Logo Design </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Photoshop </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Wordpress </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Article Writing </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> JavaScript </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Mobile App Development </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Software Architecture </span> </p>
				</div>
				<div class="col-lg-3">
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> PHP </span> </p>
					<p> <i class="primary-color fas fa-caret-right fa-lg"></i> <span> Graphic Design </span> </p>
